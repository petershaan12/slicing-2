    ...
    <nav className="py-10">
      <div className="container mx-auto px-10">
        <div className="flex items-center ">
          ...
          <div className="lg:w-2/12 w-6/12 flex items-center justify-center md:justify-start">
            <Link
              href="/"
            ...
            >
              ...
              <span className="hover:underline">Epictetus</span>
            </Link>
          </div>
          ...
          >
            ...
            <input
              className="bg-gray-700 px-6 py-3 w-full lg:rounded-full rounded-lg bg-search pl-12"
              type="text"
              placeholder="Search...."
            />
          </div>
